...
1. Verify the MCP URL is publicly reachable: `curl https://your-publisher.example.com/mcp/` (Streamable HTTP) or `https://your-publisher.example.com/mcp-sse/sse` (legacy SSE).
